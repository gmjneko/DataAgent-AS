...
public class AskUserTool implements MarkAgentTool {
    ...
    @Tool(
            ...
            description = "Ask the user a question when an operation is unclear or requires confirmation."
    ...
    public String askUser(
            ...
            @ToolParam(
                    name = "questions",
                    description = "Structured questions. Each item has question (prompt), options"
